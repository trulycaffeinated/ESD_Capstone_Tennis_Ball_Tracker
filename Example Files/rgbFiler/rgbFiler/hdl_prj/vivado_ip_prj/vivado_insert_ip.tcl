...
update_ip_catalog -delete_ip {./ipcore/rgb_filte_ip_v1_0/component.xml} -repo_path {./ipcore} -quiet
update_ip_catalog -add_ip {./ipcore/rgb_filte_ip_v1_0.zip} -repo_path {./ipcore}
update_ip_catalog
set HDLCODERIPVLNV [get_property VLNV [get_ipdefs -filter {NAME==rgb_filte_ip && VERSION==1.0}]]
set HDLCODERIPINST rgb_filte_ip_0
