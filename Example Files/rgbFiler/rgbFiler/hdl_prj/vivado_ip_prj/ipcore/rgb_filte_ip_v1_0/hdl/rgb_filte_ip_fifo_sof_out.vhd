-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\rgbFilter_2024a\rgb_filte_ip_fifo_sof_out.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: rgb_filte_ip_fifo_sof_out
-- Source Path: rgb_filte_ip/rgb_filte_ip_axi4_stream_video_master/rgb_filte_ip_fifo_sof_out
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY rgb_filte_ip_fifo_sof_out IS
...
END rgb_filte_ip_fifo_sof_out;


ARCHITECTURE rtl OF rgb_filte_ip_fifo_sof_out IS

  -- Component Declarations
  COMPONENT rgb_filte_ip_SimpleDualPortRAM_singlebit
  ...
  FOR ALL : rgb_filte_ip_SimpleDualPortRAM_singlebit
    USE ENTITY work.rgb_filte_ip_SimpleDualPortRAM_singlebit(rtl);
...
BEGIN
  ...
  u_rgb_filte_ip_fifo_sof_out_classic_ram_singlebit : rgb_filte_ip_SimpleDualPortRAM_singlebit
