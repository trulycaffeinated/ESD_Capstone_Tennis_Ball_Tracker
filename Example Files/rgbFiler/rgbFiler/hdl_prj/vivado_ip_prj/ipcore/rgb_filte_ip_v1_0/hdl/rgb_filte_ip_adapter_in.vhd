-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\rgbFilter_2024a\rgb_filte_ip_adapter_in.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: rgb_filte_ip_adapter_in
-- Source Path: rgb_filte_ip/rgb_filte_ip_axi4_stream_video_slave/rgb_filte_ip_adapter_in
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY rgb_filte_ip_adapter_in IS
...
END rgb_filte_ip_adapter_in;


ARCHITECTURE rtl OF rgb_filte_ip_adapter_in IS

  -- Component Declarations
  COMPONENT rgb_filte_ip_adapter_in_module
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  FOR ALL : rgb_filte_ip_adapter_in_module
    USE ENTITY work.rgb_filte_ip_adapter_in_module(rtl);

  -- Signals
  SIGNAL user_pixel_tmp                   : std_logic_vector(63 DOWNTO 0);  -- ufix64

BEGIN
  u_rgb_filte_ip_rgb_filte_ip_axi4_stream_video_slave_rgb_filte_ip_adapter_in_rgb_filte_ip_adapter_in_module : rgb_filte_ip_adapter_in_module
    PORT MAP( clk => clk,
              reset => reset,
