-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\rgbFilter_2024a\rgb_filte_ip_axi4_stream_video_slave.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: rgb_filte_ip_axi4_stream_video_slave
-- Source Path: rgb_filte_ip/rgb_filte_ip_axi4_stream_video_slave
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY rgb_filte_ip_axi4_stream_video_slave IS
...
END rgb_filte_ip_axi4_stream_video_slave;


ARCHITECTURE rtl OF rgb_filte_ip_axi4_stream_video_slave IS

  -- Component Declarations
  COMPONENT rgb_filte_ip_fifo_eol
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  COMPONENT rgb_filte_ip_fifo_sof
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          In_rsvd                         :   IN    std_logic;  -- ufix1
  ...
  COMPONENT rgb_filte_ip_adapter_in
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
  ...
  COMPONENT rgb_filte_ip_fifo_data
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  FOR ALL : rgb_filte_ip_fifo_eol
    USE ENTITY work.rgb_filte_ip_fifo_eol(rtl);

  FOR ALL : rgb_filte_ip_fifo_sof
    USE ENTITY work.rgb_filte_ip_fifo_sof(rtl);

  FOR ALL : rgb_filte_ip_adapter_in
    USE ENTITY work.rgb_filte_ip_adapter_in(rtl);

  FOR ALL : rgb_filte_ip_fifo_data
    USE ENTITY work.rgb_filte_ip_fifo_data(rtl);
...
BEGIN
  u_rgb_filte_ip_fifo_eol_inst : rgb_filte_ip_fifo_eol
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_rgb_filte_ip_fifo_sof_inst : rgb_filte_ip_fifo_sof
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_rgb_filte_ip_rgb_filte_ip_axi4_stream_video_slave_rgb_filte_ip_adapter_in : rgb_filte_ip_adapter_in
    PORT MAP( clk => clk,
              reset => reset,
  ...
  u_rgb_filte_ip_fifo_data_inst : rgb_filte_ip_fifo_data
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
