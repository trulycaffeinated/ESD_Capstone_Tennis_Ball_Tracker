-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\rgbFilter_2024a\rgb_filte_ip_fifo_data_OUT.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: rgb_filte_ip_fifo_data_OUT
-- Source Path: rgb_filte_ip/rgb_filte_ip_axi4_stream_video_master/rgb_filte_ip_fifo_data_OUT
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY rgb_filte_ip_fifo_data_OUT IS
...
END rgb_filte_ip_fifo_data_OUT;


ARCHITECTURE rtl OF rgb_filte_ip_fifo_data_OUT IS

  -- Component Declarations
  COMPONENT rgb_filte_ip_SimpleDualPortRAM_generic
  ...
  FOR ALL : rgb_filte_ip_SimpleDualPortRAM_generic
    USE ENTITY work.rgb_filte_ip_SimpleDualPortRAM_generic(rtl);
...
BEGIN
  ...
  u_rgb_filte_ip_fifo_data_OUT_classic_ram_generic : rgb_filte_ip_SimpleDualPortRAM_generic
