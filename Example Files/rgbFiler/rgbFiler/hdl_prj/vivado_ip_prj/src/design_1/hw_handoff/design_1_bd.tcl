...
proc create_root_design { parentCell } {
  ...
  # Create instance: rgb_filte_ip_0, and set properties
  set rgb_filte_ip_0 [ create_bd_cell -type ip -vlnv rit.edu:ip:rgb_filte_ip:1.0 rgb_filte_ip_0 ]
  ...
  connect_bd_intf_net -intf_net axis_broadcaster_0_M00_AXIS [get_bd_intf_pins axis_broadcaster_0/M00_AXIS] [get_bd_intf_pins rgb_filte_ip_0/AXI4_Stream_Video_Slave]
  ...
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M05_AXI [get_bd_intf_pins ps7_0_axi_periph/M05_AXI] [get_bd_intf_pins rgb_filte_ip_0/AXI4_Lite]
  ...
  connect_bd_intf_net -intf_net rgb_filte_ip_0_AXI4_Stream_Video_Master [get_bd_intf_pins axi_vdma_2/S_AXIS_S2MM] [get_bd_intf_pins rgb_filte_ip_0/AXI4_Stream_Video_Master]
  ...
  connect_bd_net -net rst_ps7_0_50M_peripheral_aresetn [get_bd_pins axi_vdma_1/axi_resetn] [get_bd_pins axi_vdma_2/axi_resetn] [get_bd_pins axi_vdma_3/axi_resetn] [get_bd_pins axis_broadcaster_0/aresetn] [get_bd_pins cam_axi_1/s00_axi_aresetn] [get_bd_pins cam_axi_2/s00_axi_aresetn] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/M01_ARESETN] [get_bd_pins ps7_0_axi_periph/M02_ARESETN] [get_bd_pins ps7_0_axi_periph/M03_ARESETN] [get_bd_pins ps7_0_axi_periph/M04_ARESETN] [get_bd_pins ps7_0_axi_periph/M05_ARESETN] [get_bd_pins ps7_0_axi_periph/M06_ARESETN] [get_bd_pins ps7_0_axi_periph/M07_ARESETN] [get_bd_pins ps7_0_axi_periph/M08_ARESETN] [get_bd_pins ps7_0_axi_periph/M09_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins read_trigger_0/s00_axi_aresetn] [get_bd_pins rgb_filte_ip_0/AXI4_Lite_ARESETN] [get_bd_pins rgb_filte_ip_0/IPCORE_RESETN] [get_bd_pins rst_ps7_0_50M/peripheral_aresetn] [get_bd_pins smartconnect_1/aresetn]
  ...
  create_bd_addr_seg -range 0x00010000 -offset 0x43C60000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs rgb_filte_ip_0/AXI4_Lite/reg0] SEG_rgb_filte_ip_0_reg0
