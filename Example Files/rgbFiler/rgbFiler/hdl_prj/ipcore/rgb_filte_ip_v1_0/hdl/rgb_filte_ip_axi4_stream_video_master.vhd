-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\rgbFilter_2024a\rgb_filte_ip_axi4_stream_video_master.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: rgb_filte_ip_axi4_stream_video_master
-- Source Path: rgb_filte_ip/rgb_filte_ip_axi4_stream_video_master
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY rgb_filte_ip_axi4_stream_video_master IS
...
END rgb_filte_ip_axi4_stream_video_master;


ARCHITECTURE rtl OF rgb_filte_ip_axi4_stream_video_master IS

  -- Component Declarations
  COMPONENT rgb_filte_ip_fifo_data_OUT
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  COMPONENT rgb_filte_ip_fifo_eol_out
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
  ...
  COMPONENT rgb_filte_ip_fifo_sof_out
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          In_rsvd                         :   IN    std_logic;  -- ufix1
  ...
  FOR ALL : rgb_filte_ip_fifo_data_OUT
    USE ENTITY work.rgb_filte_ip_fifo_data_OUT(rtl);

  FOR ALL : rgb_filte_ip_fifo_eol_out
    USE ENTITY work.rgb_filte_ip_fifo_eol_out(rtl);

  FOR ALL : rgb_filte_ip_fifo_sof_out
    USE ENTITY work.rgb_filte_ip_fifo_sof_out(rtl);
...
BEGIN
  u_rgb_filte_ip_fifo_data_OUT_inst : rgb_filte_ip_fifo_data_OUT
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_rgb_filte_ip_fifo_eol_out_inst : rgb_filte_ip_fifo_eol_out
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
  ...
  u_rgb_filte_ip_fifo_sof_out_inst : rgb_filte_ip_fifo_sof_out
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
