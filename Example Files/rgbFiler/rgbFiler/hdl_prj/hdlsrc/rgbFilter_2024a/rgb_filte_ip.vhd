-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\rgbFilter_2024a\rgb_filte_ip.vhd
...
ARCHITECTURE rtl OF rgb_filte_ip IS

  -- Component Declarations
  COMPONENT rgb_filte_ip_reset_sync
  ...
  COMPONENT rgb_filte_ip_axi_lite
  ...
  COMPONENT rgb_filte_ip_axi4_stream_video_slave
    PORT( clk                             :   IN    std_logic;  -- ufix1
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          AXI4_Stream_Video_Slave_TDATA   :   IN    std_logic_vector(63 DOWNTO 0);  -- ufix64
  ...
  COMPONENT rgb_filte_ip_axi4_stream_video_master
    PORT( clk                             :   IN    std_logic;  -- ufix1
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          AXI4_Stream_Video_Master_TREADY :   IN    std_logic;  -- ufix1
  ...
  FOR ALL : rgb_filte_ip_reset_sync
    USE ENTITY work.rgb_filte_ip_reset_sync(rtl);

  FOR ALL : rgb_filte_ip_axi_lite
    USE ENTITY work.rgb_filte_ip_axi_lite(rtl);

  FOR ALL : rgb_filte_ip_axi4_stream_video_slave
    USE ENTITY work.rgb_filte_ip_axi4_stream_video_slave(rtl);

  FOR ALL : rgb_filte_ip_dut
    USE ENTITY work.rgb_filte_ip_dut(rtl);

  FOR ALL : rgb_filte_ip_axi4_stream_video_master
    USE ENTITY work.rgb_filte_ip_axi4_stream_video_master(rtl);
  ...
  SIGNAL write_red                        : std_logic_vector(7 DOWNTO 0);  -- ufix8
  SIGNAL write_green                      : std_logic_vector(7 DOWNTO 0);  -- ufix8
  SIGNAL write_blue                       : std_logic_vector(7 DOWNTO 0);  -- ufix8
...
BEGIN
  u_rgb_filte_ip_reset_sync_inst : rgb_filte_ip_reset_sync
    PORT MAP( clk => IPCORE_CLK,  -- ufix1
              reset_in => reset_before_sync,  -- ufix1
              reset_out => reset
              );

  u_rgb_filte_ip_axi_lite_inst : rgb_filte_ip_axi_lite
    PORT MAP( reset => reset,
              ...
              write_red => write_red,  -- ufix8
              write_green => write_green,  -- ufix8
              write_blue => write_blue,  -- ufix8
              reset_internal => reset_internal  -- ufix1
              );

  u_rgb_filte_ip_axi4_stream_video_slave_inst : rgb_filte_ip_axi4_stream_video_slave
    PORT MAP( clk => IPCORE_CLK,  -- ufix1
              reset => reset,
              enb => const_1_1,
  ...
  u_rgb_filte_ip_dut_inst : rgb_filte_ip_dut
    PORT MAP( clk => IPCORE_CLK,  -- ufix1
              reset => reset,
              dut_enable => dut_enable,  -- ufix1
              red => write_red,  -- ufix8
              green => write_green,  -- ufix8
              blue => write_blue,  -- ufix8
  ...
  u_rgb_filte_ip_axi4_stream_video_master_inst : rgb_filte_ip_axi4_stream_video_master
    PORT MAP( clk => IPCORE_CLK,  -- ufix1
              reset => reset,
              enb => const_1_1,
  ...
  ip_timestamp <= unsigned'(X"95349450");
