...
% This script was created for the IP Core generated from design 'sobelFilter2024a'.
% 
...
% programFPGA(hProcessor, "hdl_prj\vivado_ip_prj\vivado_prj.runs\impl_1\design_1_wrapper.bit", "");
...
gs_sobelFilter2024a_setup(hFPGA);
